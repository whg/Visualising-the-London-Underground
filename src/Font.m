...
- (void) printString : (NSString *) s : (NSPoint) p {
	...
	glCallLists(strlen(input), GL_UNSIGNED_BYTE, (GLubyte *) input);
	glPopAttrib();
}


//prints a whole load of characters
- (void) test {	
	glColor3f(1, 1, 1);
	...
	for (i = 32; i < 127; i += 32) {
		...
		teststring[32] = 0;
		[self printString:[NSString stringWithUTF8String:teststring] : NSMakePoint(0, 0)];
	}
